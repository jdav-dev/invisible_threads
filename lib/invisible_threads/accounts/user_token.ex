defmodule InvisibleThreads.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  """
  def by_user_and_contexts_query(:all) do
    UserToken
  end

  def by_user_and_contexts_query([_ | _] = contexts) do
    from t in UserToken, where: t.context in ^contexts
  end
