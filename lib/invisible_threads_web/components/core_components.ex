defmodule InvisibleThreadsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(InvisibleThreadsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(InvisibleThreadsWeb.Gettext, "errors", msg, opts)
    # end
